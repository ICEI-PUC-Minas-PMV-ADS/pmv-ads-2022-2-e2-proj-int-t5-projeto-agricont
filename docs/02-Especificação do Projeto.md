...
|--------------------|------------------------------------|----------------------------------------|
|<img src="img/Susy.jpg" height 200 > | **Idade:** 29 anos <br> **Ocupação:** Engenharia Agrônoma, Gerente na propriedade da família.|**Aplicativos:**<br><ul>● Facebook<br>● Netflix<br>● Twitter<br>● Instagram</ul>|
